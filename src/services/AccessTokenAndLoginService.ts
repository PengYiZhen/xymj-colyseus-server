...
export class AccessTokenAndLoginService {
    ...
    public async getDouYinLoginUserInfoOpenid(
        ...
        try {
            ...
            const openidKey =
                ...
                response.data.anonymous_openid ||
            ...
            if (openidKey) {
                const dbUser = await this.authService.findOrCreateMinigameUser({
                    openid: openidKey,
                    platform: 'douyin',
                });
                user = dbUser as Omit<User, 'password'>;
    ...
    public async getWeixinLoginUserInfoOpenid(
        ...
        try {
            ...
            const openidKey = response.data.openid || response.data.unionid || '';
